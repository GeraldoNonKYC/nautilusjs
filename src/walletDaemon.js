...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/nautiluswalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { nautiluswalletd } = gRPC.loadPackageDefinition(packageDefinition).nautiluswalletd

    this._client = new nautiluswalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
